...
If you want, I can follow this with a **second tutorial** that upgrades this demo into a more realistic credential system by adding an **issuer signature** or **Merkle membership proof**.
